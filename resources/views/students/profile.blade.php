    ...
    <div class="netw-inicio" style="">
        ...
        <div class="col-12 col-md-9 mx-auto">
            ...
            <div class="col-12 text-center">
                <img class="img img-fluid p-3 rounded-circle" src="https://pixlr.com/images/index/remove-bg.webp" style="height: 300px; width:300px; object-fit: cover;" alt="FOTO PERFIL">
            </div>

            <h1 class="text-center">
                Edna Alexandra Lecea Contreras
